        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.rol == "Estudiante") {
                    ...
                    messageValidateLogin = "Sesión iniciada correctamente";
                    var response = $('#correctLabelLogin');
                    response.removeClass();
                    response.addClass("alert alert-success register-alert");
                    ...
                    messageValidateLogin = "";
                    messageValidateLogin = "El usuario no existe en los registros";
