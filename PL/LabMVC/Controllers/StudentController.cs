    ...
    public class StudentController : Controller
    {
        ...
        public ActionResult UpdateApprovalAcceptDenyStudent([FromBody] User user)
        {
            ...
            if (user.Approval == "Aceptado")
            {
               ...
               "<html><body ><h1>Estimado/a " + user.Name + "</h1><br/>" +
               "<br/><h3>Sede: Atlántico<br/>" +
               "<br/>Queremos informarle que su solicitud de inscripción a la carrera de Informática Empresarial ha sido aceptada con éxito, por este medio le recordamos de igual manera que su carné estudiantil es " + user.IdCard + ", el cuál será de suma importancia para los trámites oficiales dentro de la Universidad <br/>" +
               "<br/>Le pedimos porfavor que verifique la carrera en el sitio oficial de E-Matrícula(https://ematricula.ucr.ac.cr/ematricula/) con motivo del cercano proceso de matrícula para este nuevo semestre. Así mismo registrarse en el sitio oficial de la Universidad para el manejo de cada curso y sus respectivos entornos, Mediación Virtual(https://mv1.mediacionvirtual.ucr.ac.cr/login/index.php)<br/>" +
               "<br/>- Oficina de Orientación y Registro.</h3></body></html>");
            ...
            else
            {
                ...
                studentDAO.SendEmail(user.Email, "❁→❝Solicitud de inscripción Rechazada❞❁",
                               "<html><body ><h1>Estimado/a " + user.Name + "</h1><br/>" +
                               "<br/><h3>Sede: Atlántico<br/>" +
                               "<br/>Queremos informarle que su solicitud de inscripción a la carrera de Informática Empresarial ha sido rechazada, por lo tanto su actividad dentro de la carrera estará automaticamente inactiva dentro de los registros de la carrera respectivamente. <br/>" +
        ...
        public ActionResult SendConsult([FromBody] ProfessorConsultation professorConsultation)
        {
            ...
            studentDAO.SendEmail(professor.Email, "❁→❝Solicitud de consulta❞❁",
                          ...
                          "<br/><h3>El estudiante " + professorConsultation.IdCardStudent + " - " + professorConsultation.StudentName + " le solicita o pregunta lo siguiente lo siguiente:<br/>" +
